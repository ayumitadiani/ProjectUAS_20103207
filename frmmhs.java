...
public class frmmhs extends javax.swing.JInternalFrame {
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGap(2, 2, 2)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                    .addComponent(txJKL, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(txJKP)))
    ...
    private void dt_mhsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dt_mhsMouseClicked
        ...
        this.txTGL.setText(model.getValueAt(dt_mhs.getSelectedRow(),3).toString());
        this.txJUR.setSelectedItem(model.getValueAt(dt_mhs.getSelectedRow(),4).toString());
    ...
    private void cmdStroeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdStroeActionPerformed
       ...
       String JURUSAN = this.txJUR.getSelectedItem().toString();
       String TGL=this.txTGL.getText();
       String SQLInsert = "INSERT INTO mhs (Nama,NIM,Jns_Kelamin,Jurusan,TGL_Lahir) VALUES('"+NAMA+"','"+NIM+"','"+JNS_KL+"','"+JURUSAN+"','"+TGL+"');";
